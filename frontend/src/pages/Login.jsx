...
import { Camera, Eye, EyeOff, Sparkles, Loader2, ArrowLeft } from "lucide-react"; // ✅ FIX: ArrowLeft icon import kiya hai
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only allow photographers to login through this page
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4 relative overflow-hidden">
      ...
      {/* ✅ FIX: Back button add kiya hai */}
      <Button
        variant="ghost"
        size="icon"
        className="absolute top-6 left-6 z-20 rounded-full"
        onClick={() => navigate("/")} // Pichle page par janay ke liye
      >
